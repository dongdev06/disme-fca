...
## Install
If you just want to use disme-fca, you should use this command:
```bash
npm install disme-fca
```
It will download `disme-fca` from NPM repositories
